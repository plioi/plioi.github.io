...
<p>Some languages embrace mutation (the changing of variables' values at runtime).  Python and Ruby classes have publicly-settable <em>everything</em> and although this can get you into trouble it can also lead to some pretty slick tools like Ruby on Rails.  Clojure, on the other hand, fears mutation.</p><!--more-->
